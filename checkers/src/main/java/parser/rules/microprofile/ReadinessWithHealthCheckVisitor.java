...
public class ReadinessWithHealthCheckVisitor extends VoidVisitorAdapter<Object> {
    private String projectName;
    private String filepath;

    public ReadinessWithHealthCheckVisitor(String projectName,
                                           String filePath) {
        if (projectName == null || filePath == null) {
            throw new RuntimeException("[ReadinessAndHealthCheck] projectName, filePath, and importDecls cannot be null!");
        }
    ...
    public void visit(ClassOrInterfaceDeclaration c, Object arg) {
        ...
        for (AnnotationExpr annotation : classAnnotations) {
            hasReadiness = Helper.annotationExists(annotation, "org.eclipse.microprofile.health.Readiness");
            if (hasReadiness) {
                break;
            }
        }
        ...
        boolean antecedent = hasReadiness;
        ...
        if (antecedent && !consequent) {
            ...
            Violation.print("@Readiness on class --> Class implements HealthCheck", classLoc);
        }
